#ifndef BITWISE_BIT_MACROS_H
#define BITWISE_BIT_MACROS_H

#include <cinttypes>
#include <sched.h>

// trailing_zeros is number of the least significant zeros
// leading_zeros is number of the most significant zeros
#if defined(_WIN32)

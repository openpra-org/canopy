...
if(NOT _openmp_FOUND)
    ...
    if(OpenMP_CXX_FOUND)
        ...
        message(DEBUG "    OpenMP_CXX_VERSION: ${OpenMP_CXX_VERSION}")
        message(DEBUG "    OpenMP_CXX_FLAGS: ${OpenMP_CXX_FLAGS}")
        message(DEBUG "    OpenMP_CXX_INCLUDE_DIRS: ${OpenMP_CXX_INCLUDE_DIRS}")
        message(DEBUG "    OpenMP_CXX_LIBRARIES: ${OpenMP_CXX_LIBRARIES}")
